...
class Onboarding_screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    FilledButton Start_button = FilledButton(onPressed: ()=> Navigator.pushNamedAndRemoveUntil(context, "/onboarding", (route) => false), child: Text("Continue",style: TextStyle(fontWeight: FontWeight.w900),),style: cons.Button_style);
